/* Play the video without the backing video!
 * jsut the overlay part
 */
...
gchar *markup[] = {"<span font=\"28\" foreground=\"RED\">",
		   "</span><span font=\"28\" foreground=\"blue\">",
		   "</span>"};
...
static void *play_background(void *args) {
    ...
    */
    ...
    while (1) {
	usleep(100000);  // 29.7 frames per second
 ...
 */
ControlMode *interface_o_loader(void)
{
    return &video_ctl;
}
