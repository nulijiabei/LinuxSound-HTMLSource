...
int height_lyric_pixbufs[] = {100, 200, 300}; // vertical offset of lyric in video
...
static void draw_text(char *text, float red, float green, float blue, int height) {
...
static void ctl_lyric(int lyricid)
{
	...
	current_line += 1;
	current_panel = (current_panel + 1) % NUM_LINES;
...
static void ctl_event(CtlEvent *e)
{
	...
	case CTLE_LOADING_DONE:
		...
		draw_text(lyrics_array[n]->str,
			  0.0, 0.0, 1.0, height_lyric_pixbufs[n]);
	    }
