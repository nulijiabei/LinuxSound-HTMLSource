...
extern void *play_audio(void *args);
...
static void init_timidity() {
    ...
    /* dontrol event handling */
    ctl = &karaoke_ctl;
    //ctl->trace_playing = 1;
    //opt_trace_text_meta_event = 1;
    
    play_mode = &alsa_play_mode;
    play_mode->name = "default";
    //play_mode->name = "plug:dmix";
}
...
static void realize_cb (GtkWidget *widget, gpointer data) {
    ...
    pthread_t audio_id;
    pthread_create(&audio_id, NULL, play_audio, NULL);
}
